...
MELODY_IDX = melody_info["index"]
MELODY_NAME_CN = melody_info["partName"]
EN_PART_NAMES = ["Violin I", "Violin II", "Viola", "Cello"]
MELODY_EN_NAME = EN_PART_NAMES[MELODY_IDX]
...
p = score.measures(1, 272).plot(show=False)
...
selected_measures = score_part.measures(1, 20)
...
selected_parts = ["Violin I"]  #todo: you can change parts here
