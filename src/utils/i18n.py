...
TRANSLATIONS = {
    ...
    "dialog.url_label": {"zh": "输入音频文件的 URL (.wav):", "en": "Enter URL of audio file (.wav):"},
    "dialog.url_placeholder": {"zh": "https://example.com/audio/sample.wav", "en": "https://example.com/audio/sample.wav"},
    ...
    "tt.custom_merge_title": {"zh": "自定义合并", "en": "Custom Merge"},
    "tt.custom_bars_label": {"zh": "小节列表:", "en": "Bar list:"},
    "tt.btn_custom_merge": {"zh": "合并并分析", "en": "Merge & Analyze"},
    "tt.custom_bars_invalid": {"zh": "小节格式错误，请用逗号和短横线（如 1,3,5-10）", "en": "Invalid bar list. Use commas and hyphens (e.g. 1,3,5-10)"},
