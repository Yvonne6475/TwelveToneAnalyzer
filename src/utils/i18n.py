...
TRANSLATIONS = {
    ...
    "forte.btn_from_chord": {"zh": "从和弦分析获取", "en": "Get from Chord Analysis"},
    "forte.no_chord_msg": {"zh": "请先在和弦分析标签页中提取和弦。", "en": "Please extract chords first in the Chord Analysis tab."},
    ...
    "forte.table.headers": {
        "zh": ["输入集合", "Normal Order", "Intervals", "Interval Vector", "Prime Form", "Forte Class", "P", "I", "R", "RI"],
        "en": ["Input Set", "Normal Order", "Intervals", "Interval Vector", "Prime Form", "Forte Class", "P", "I", "R", "RI"]
    },
    ...
    "sr.btn_from_chord": {"zh": "从和弦分析获取", "en": "Get from Chord Analysis"},
    "sr.no_chord_msg": {"zh": "请先在'和弦分析'选项卡中提取和弦。", "en": "Please extract chords in the 'Chord Analysis' tab first."},
    ...
    "sr.trans_group": {"zh": "P / I / R / RI 变换匹配", "en": "P / I / R / RI Transformational Matches"},
    ...
    "sr.rel_item": {"zh": "[{pc}]  Forte: {forte}  Interval Vector: {iv}", "en": "[{pc}]  Forte: {forte}  Interval Vector: {iv}"},
    ...
    "chord.result_group": {"zh": "和弦分析结果", "en": "Chord Analysis Results"},
    "chord.table.headers": {
        "zh": ["小节", "偏移", "声部", "音符", "Normal Order", "Forte Class", "音域"],
        "en": ["Bar", "Offset", "Part Name", "Notes", "Normal Order", "Forte Class", "Pitch Range"],
    },
    ...
    "lattice.btn_from_chord": {"zh": "从和弦分析获取", "en": "Get from Chord Analysis"},
